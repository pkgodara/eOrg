...
if( $flagSD )
	echo "<tr><th>Start Date :</th><td> <input type=\"date\" name=Start_Date id=Start_Date placeholder=\"Date yyyy-mm-dd\" required/></td></tr>";

if( $flagED )
	echo "<tr><th>End Date :</th><td> <input type=\"date\" name=End_Date id=End_Date placeholder=\"Date yyyy-mm-dd\" required/></td></tr>";
