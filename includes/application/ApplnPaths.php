...
<br><br><br><br><br>
<p style ="font-size:25px">This is to generalise the paths of applications generated by the users. For it, first select the type of the application and then select the group of the users and then give the path (post by post) that is followed by the generated application (of the given type) for the approval (e.g., say there is a the group of users : students->btech->cse->2015and their application (of type say x) follows the path FA2015->dean->hod, then first select the type of application (here x) and then select the categories of users one by one and then give the 'posts' [in order] one by one).</p><br><br>
